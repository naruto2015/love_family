 ...
 */
public class MyBaiduMapIcon extends LinearLayout implements View.OnClickListener {
    ...
    public MyBaiduMapIcon(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        init();
    }

    public MyBaiduMapIcon(Context context, AttributeSet attrs, int defStyle) {
