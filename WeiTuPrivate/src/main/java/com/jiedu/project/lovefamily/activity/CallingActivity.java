...
public class CallingActivity extends BaseActivity implements OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(CallingActivity.this, "zzz", Toast.LENGTH_SHORT).show();
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            Toast.makeText(CallingActivity.this, "hhhhh", Toast.LENGTH_SHORT).show();
    ...
    private void initData() {
        ...
        if (bundle != null) {
            ...
            if(isVideo)
                calltype = RtcConst.CallType_A_V;//1
            else
                calltype = RtcConst.CallType_Audio;//3
            //收到来电时在此保存
            if(inCall)
    ...
    int getInCallStream() {
        ...
        if ((Build.BRAND.equalsIgnoreCase("archos")
		 ...
		 && Build.DEVICE.equalsIgnoreCase("hwC8813Q"))
		 || (Build.BRAND.equalsIgnoreCase("Huawei")
		 && Build.DEVICE.equalsIgnoreCase("hwc8813"))
		 || (Build.BRAND.equalsIgnoreCase("Xiaomi")
		 && Build.MODEL.contains("MI 3"))
		 || (Build.BRAND.equalsIgnoreCase("Xiaomi")
		 && Build.MODEL.contains("MI 2"))
		 || (Build.BRAND.equalsIgnoreCase("samsung")
		 && Build.DEVICE.equalsIgnoreCase("klte"))
		 || (Build.BRAND.equalsIgnoreCase("samsung")
		 && Build.DEVICE.equalsIgnoreCase("klteduosctc"))
		 || (Build.BRAND.equalsIgnoreCase("samsung")
		 && Build.DEVICE.equalsIgnoreCase("hllte"))
		 || (Build.BRAND.equalsIgnoreCase("samsung")
		 && Build.DEVICE.equalsIgnoreCase("trltechn"))
		 || (Build.BRAND.equalsIgnoreCase("Huawei")
		 && Build.DEVICE.equalsIgnoreCase("hwB199"))
        || (Build.BRAND.equalsIgnoreCase("TCL")
		 && Build.DEVICE.equalsIgnoreCase("Diablo_LTE"))
		 ||(Build.BRAND.equalsIgnoreCase("Xiaomi")
		 && Build.MODEL.contains("MI 4"))) {
